...
+ How much of their production can be derived from air yards vs. yards after the catch?
...
Our team struggled to score in the Red Zone last season. Who are the best pass catchers in the Red Zone from last season that we should consider acquiring?
...
+ filter pbp to only include pass plays in the Red Zone
...
redzone_grouped %>% ungroup() %>%
  gt() %>%
  tab_header(
    title = "Red Zone Receiving TD Leaders",
    subtitle = "2025 Regular Season") %>%
  gt_img_rows(headshot, height = 40) %>%
